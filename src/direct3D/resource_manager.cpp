...
/*============================================================================================================
    リソース登録
    新しいリソースをマネージャーに登録する。
    同じファイル名のリソースが既に登録されている場合は登録せず、falseを返す。
...
=============================================================================================================*/
bool ResourceManager::RegisterResource(const std::wstring& filename, std::shared_ptr<Resource> resource)
{
    // ファイル名が空の場合はエラー
    if (filename.empty())
    {
    ...
    if (m_Resources.find(filename) != m_Resources.end())
    {
        ...
        throw std::runtime_error("ResourceManager::RegisterResource - 同じファイル名のリソースが既に登録されています: " + filenameStr);
    }
...
=============================================================================================================*/
std::shared_ptr<Resource> ResourceManager::GetResource(const std::wstring& filename) const
{
